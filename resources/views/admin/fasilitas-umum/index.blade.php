...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <p class="text-sm text-[#737780]">Kelola fasilitas sekolah</p>
        <a href="{{ route('admin.fasilitas-umum.create') }}"
                        ...
                        <tr class="hover:bg-[#f9f9fc] transition-colors">
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('admin.fasilitas-umum.edit', $item) }}"
                                    ...
                                    <form method="POST" action="{{ route('admin.fasilitas-umum.destroy', $item) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-8 text-center text-[#737780]">
                                Belum ada fasilitas. <a href="{{ route('admin.fasilitas-umum.create') }}"
