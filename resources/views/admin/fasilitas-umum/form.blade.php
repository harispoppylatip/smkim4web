...
@section('title', $editMode ? 'Edit Fasilitas' : 'Tambah Fasilitas')
@section('page_title', $editMode ? 'Edit Fasilitas' : 'Tambah Fasilitas')
...
@section('content')
    <div class="max-w-2xl">
        ...
        <form method="POST"
            action="{{ $editMode ? route('admin.fasilitas-umum.update', $fasilitas) : route('admin.fasilitas-umum.store') }}"
            ...
            {{-- Nama --}}
            <div class="mb-4">
                <label class="block text-sm font-semibold text-[#1a1c1e] mb-1.5">Nama Fasilitas</label>
                <input type="text" name="nama"
                    ...
                    value="{{ old('nama', $editMode ? $fasilitas->nama : '') }}" required>
                @error('nama')
            ...
            <div class="mb-4">
                ...
                <label
                    ...
                    <div
                        ...
                        <span
                            class="text-sm font-medium">{{ $editMode && $fasilitas->gambar ? 'Klik untuk ganti gambar' : 'Klik untuk pilih gambar' }}</span>
            ...
            <div class="mb-6">
                ...
                <input type="number" name="urutan"
                    class="w-full px-3 py-2 border border-[#c3c6d1] rounded-lg text-sm focus:outline-none focus:border-[#001e40] focus:ring-2 focus:ring-[#001e40]/20"
                    value="{{ old('urutan', $editMode ? $fasilitas->urutan : 0) }}" min="0">
                @error('urutan')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
