    ...
    <aside id="mobile-sidebar"
        ...
        <nav class="py-4 px-3 space-y-1">
            @if (auth()->user()->isAdmin())
                ...
                <p class="px-3 text-[10px] font-semibold uppercase tracking-wider text-[#799dd6] mb-2 mt-4">Pengaturan
                </p>
                ...
                <x-navigation.nav-item href="{{ route('admin.pengaturan-home.index') }}" icon="settings"
                    :active="request()->routeIs('admin.pengaturan-home*')">
                    Halaman Utama
                </x-navigation.nav-item>
